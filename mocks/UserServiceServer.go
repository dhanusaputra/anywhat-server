...
func (_m *UserServiceServer) Login(_a0 context.Context, _a1 *emptypb.Empty) (*pb.LoginResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *pb.LoginResponse
	if rf, ok := ret.Get(0).(func(context.Context, *emptypb.Empty) *pb.LoginResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
